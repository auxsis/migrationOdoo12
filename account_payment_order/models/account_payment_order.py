...
class AccountPaymentOrder(models.Model):
    ...
    def generate_payment_file(self):
        ...
        for counter, line in enumerate(self.bank_line_ids):
            sheet.write(counter + 1, 0, self.company_partner_bank_id.sanitized_acc_number)
            sheet.write(counter + 1, 1, self.company_partner_bank_id.currency_id.name)
            sheet.write(counter + 1, 2, line.partner_bank_id.sanitized_acc_number)
            sheet.write(counter + 1, 3, line.partner_bank_id.currency_id.name)
            sheet.write(counter + 1, 4, line.partner_bank_id.bank_id.sbif_code)
            sheet.write(counter + 1, 5, line.partner_id.vat)
        ...
        return stream.getvalue(),self.filename
